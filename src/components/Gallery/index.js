...
function Gallery() {
  React.useEffect(() => {
    ...
    const gridItems = Array.prototype.slice.call(
      window.document.getElementsByClassName("flip-inner")
    );
    const activeImages = [];
    const vBirds = [
      "goldeneagle01",
    ...
    const getNewBird = (isVertical) => {
      ...
      return getRandomArrayItem(
        images.filter((i) => !activeImages.includes(i))
      );
    };

    const generateUrl = (bird, isVertical) => {
      return isVertical
  ...
  return (
    <>
      <section id="gallery" className="gallery">
        <div className="side horizontal flip-outer">
          <div id="1" className="flip-inner">
            <img className="front" alt="" />
            <img className="back" alt="" />
          </div>
        </div>
        <div className="center">
          <div className="vertical top flip-outer">
            <div id="2" className="flip-inner">
              <img className="front" alt="" />
              <img className="back" alt="" />
            </div>
          </div>
          <div className="horizontal top flip-outer">
            <div id="3" className="flip-inner">
              <img className="front" alt="" />
              <img className="back" alt="" />
            </div>
          </div>
          <div className="horizontal bottom flip-outer">
            <div id="4" className="flip-inner">
              <img className="front" alt="" />
              <img className="back" alt="" />
            </div>
          </div>
          <div className="vertical bottom flip-outer">
            <div id="5" className="flip-inner">
              <img className="front" alt="" />
              <img className="back" alt="" />
            </div>
          </div>
